            ...
            <div class="panel-body">
                  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align: center">
                    ...
                    <tr>
                           ...
                           <th colspan="4" align="center"> <a class="btn btn-info navbar-right" type="botton" style="position: relative; margin-right: 10px;" href="<?php echo base_url()?>index.php/claporanpdf/room3">Print</a></t>
                    </tr>
                  </table>
